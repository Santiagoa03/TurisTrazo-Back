    ...
    SecurityFilterChain filterChain(HttpSecurity http, AuthenticationManager authManager) throws Exception {
        ...
        return http.cors().and()
                ...
                .authorizeHttpRequests(authorize -> authorize
                        ...
                        .requestMatchers(new AntPathRequestMatcher("/api/users/reset")).permitAll()
                        ...
                        .requestMatchers(new AntPathRequestMatcher("/api/reserva/**")).permitAll()
                        .requestMatchers(new AntPathRequestMatcher("/api/imagen/**")).permitAll()
